  ...
  return (
    <div className="max-w-2xl mx-auto w-full py-8">
      ...
      <ConfirmationModal
        ...
        description="Are you sure you want to remove your profile picture? This will revert to the default initials avatar."
        confirmText="Remove"
        variant="danger"
           ...
           <div className="bg-white dark:bg-[#1a2430] p-6 border-t border-[#e8edf3] dark:border-[#2d3a4a] flex flex-col gap-4">
              ...
              <div className="flex justify-center gap-4">
                 <button 
                    ...
                    className="px-6 py-2 rounded-lg text-white font-bold text-sm bg-gray-600 hover:bg-gray-700 transition-colors"
                 >
                    Cancel
                 </button>
                 <button 
                    onClick={performCrop}
                    /* FIX: Dynamic Background, Hover, and Shadow */
                    className="px-6 py-2 rounded-lg text-white font-bold text-sm bg-primary hover:bg-primary-hover transition-colors shadow-lg shadow-primary/30"
                 >
                    Apply Crop
                 </button>
              </div>
      ...
      <h2 className="text-2xl font-bold text-[#0e141b] dark:text-[#e8edf3] mb-2">Public Profile</h2>
      <p className="text-[#507395] dark:text-[#94a3b8] mb-8">Manage how others see you in your workspaces.</p>
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
           ...
           <div className="flex flex-col items-center gap-4">
              <div className="relative group">
                 ...
                 <div className={`size-32 rounded-full overflow-hidden relative ring-4 transition-all ${
                     previewUrl ? "ring-amber-400" : "ring-white dark:ring-[#2d3a4a]"
                 } shadow-md`}>
                    {previewUrl ? (
                        ...
                        /* FIX: Dynamic Fallback Background */
                 ...
                 {user?.avatarUrl && !previewUrl && (
                    <button 
                        ...
                        className="absolute bottom-0 right-0 p-2 bg-white dark:bg-[#2d3a4a] text-red-500 hover:text-red-600 rounded-full shadow-md border border-gray-200 dark:border-gray-700 flex items-center justify-center hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
                        title="Remove profile picture"
                    >
                 ...
                 {previewUrl && (
                     <button 
                        ...
                        className="absolute bottom-0 right-0 p-2 bg-white dark:bg-[#2d3a4a] text-gray-500 hover:text-gray-700 rounded-full shadow-md border border-gray-200 dark:border-gray-700 flex items-center justify-center hover:bg-gray-100 transition-colors"
              ...
              <p className="text-xs text-[#507395] dark:text-[#94a3b8]">Allowed: JPG, PNG, WEBP. Max 5MB.</p>
           </div>
           ...
           <div className="flex-1 w-full max-w-md space-y-6 pt-2">
              <div className="space-y-1.5">
                ...
                {errors.displayName ? (
                   ...
                   <p className="text-xs text-[#507395] dark:text-[#94a3b8] mt-1">This name will be visible to other members.</p>
                )}
              </div>
              ...
              <div className="space-y-1.5">
                 ...
                 <p className="text-xs text-[#507395] dark:text-[#94a3b8] mt-1">Email address cannot be changed.</p>
              </div>
              ...
              <div className="pt-4 flex justify-end">
                 <button
                    ...
                    className="px-6 py-2.5 rounded-lg bg-primary text-white text-sm font-bold shadow-sm hover:bg-primary-hover transition-all disabled:opacity-50 disabled:cursor-not-allowed active:scale-95 flex items-center gap-2"
                 >
