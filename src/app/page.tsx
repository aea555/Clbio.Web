        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="max-w-4xl mb-24">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-foreground tracking-tightest leading-[1.1] mb-8">
              Full-Stack <br /> 
              <span className="text-primary italic">.NET Architecture.</span>
            </h1>
            
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-10 max-w-2xl">
              A robust project management system engineered with <span className="text-foreground font-semibold">ASP.NET Core</span> and <span className="text-foreground font-semibold">Next.js</span>. 
              Featuring real-time event broadcasting via <span className="text-foreground font-semibold">SignalR Hubs</span> and a persistence layer powered by <span className="text-foreground font-semibold">EF Core</span>.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
            {[
              { icon: "hub", title: "SignalR Integration", desc: "Real-time communication via .NET SignalR, utilizing persistent connections for live UI reactivity." },
              { icon: "layers", title: "Clean Architecture", desc: "Backend follows N-Layer patterns with clear separation of Concerns, Repositories, and Business Logic." },
              { icon: "security", title: "Identity & JWT", desc: "Stateless authentication using ASP.NET Core Identity and JWT tokens for secure, scalable API access." },
            ].map((feature, i) => (
          ...
          <div className="bg-primary/5 border border-primary/10 rounded-3xl p-8 mb-32 flex flex-col md:flex-row items-center gap-8">
            ...
            <div>
              <h3 className="text-xl font-bold text-foreground mb-1">Portfolio Note</h3>
              <p className="text-muted-foreground text-sm">
                This project is a technical showcase for <span className="text-primary font-bold">aea555</span>. It is intended to demonstrate a high level of full-stack proficiency, particularly in handling complex state and real-time backend events.
              </p>
            </div>
          </div>
      ...
      <footer className="border-t border-border-base bg-card py-12">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
          <div>
            ...
            <p className="text-xs text-muted-foreground">© 2025 Engineering Showcase by aea555</p>
          </div>
