...
import { useBoards, useWorkspace, useOnlinePresence, useWorkspaceMembers } from "@/hooks/use-queries";
    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <ConfirmationModal
                ...
                description={t("delete_modal.description", { name: deletingBoard?.name ?? "" })}
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-6">
                <div>
                    <h2 className="text-3xl font-bold text-[#0e141b] dark:text-[#e8edf3] mb-2 tracking-tight">{t("title")}</h2>
                ...
                <div className="flex items-center gap-3">
                    <div className="relative">
                        ...
                        >
                            <option value="Most Recent">{t("sort.most_recent")}</option>
                            <option value="Alphabetical">{t("sort.alphabetical")}</option>
                            <option value="Last Updated">{t("sort.last_updated")}</option>
                        </select>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 pb-10">
                {canCreateBoard && (
                    ...
                    >
                        ...
                        <span className="text-sm font-medium text-[#507395] group-hover:text-primary transition-colors">{t("create_new_board_tile")}</span>
                    </button>
                )}
