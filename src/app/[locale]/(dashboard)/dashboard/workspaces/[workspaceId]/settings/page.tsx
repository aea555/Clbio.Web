...
import { useTranslations } from "next-intl"; ///settings/general/page.tsx]
...
export default function WorkspaceGeneralSettingsPage() {
  const t = useTranslations("WorkspaceSettings"); ///settings/general/page.tsx]
  ...
  const updateWorkspaceSchema = z.object({
    name: z.string().min(3, t("errors.name_min")).max(50, t("errors.name_max")),
    description: z.string().max(200, t("errors.desc_max")).optional(),
  });
  ...
  return (
    <div className="flex flex-col min-h-full">
      ...
      <ConfirmationModal
        ...
        description={t("modals.delete_desc", { name: workspace?.name })}
        confirmText={t("modals.delete_confirm")}
        variant="danger"
      ...
      <ConfirmationModal
        ...
        title={t("modals.archive_title")}
        description={t("modals.archive_desc", { name: workspace?.name })}
        confirmText={t("modals.archive_confirm")}
        variant="warning"
      ...
      <ConfirmationModal
        ...
        title={t("modals.restore_title")}
        description={t("modals.restore_desc", { name: workspace?.name })}
        confirmText={t("modals.restore_confirm")}
        variant="primary"
      ...
      <ConfirmationModal
        ...
        title={t("modals.leave_title")}
        description={t("modals.leave_desc")}
        confirmText={t("modals.leave_confirm")}
        variant="danger"
      ...
      <div className="max-w-4xl mx-auto w-full">
        ...
        <div className="space-y-8">
          ...
          <section className={`bg-white dark:bg-[#1a2430] rounded-xl border border-[#e8edf3] dark:border-[#2d3a4a] p-6 shadow-sm transition-opacity duration-300 ${isArchived ? "bg-gray-50/50" : ""}`}>
            ...
            <h3 className="text-lg font-bold text-[#0e141b] dark:text-[#e8edf3] mb-4">{t("general_info")}</h3>
          ...
          {(can(Permission.ArchiveWorkspace) || can(Permission.DeleteWorkspace) || !isOwner) && (
            <section className="bg-red-50 dark:bg-red-900/10 rounded-xl border border-red-100 dark:border-red-900/30 p-6">
              <h3 className="text-lg font-bold text-red-600 dark:text-red-400 mb-2">{t("actions_title")}</h3>
